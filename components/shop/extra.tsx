        ...
        <>
            ...
            <div className="w-full flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={decrement} className="bg-[#F4F3EB] w-6 h-6 rounded-full flex justify-center items-center">
                        -
                    </button>
                    <p>{count}</p>
                    <button onClick={increment} className="bg-[#F4F3EB] w-6 h-6 rounded-full flex justify-center items-center">
                        +
                    </button>
                </div>
            </div>
