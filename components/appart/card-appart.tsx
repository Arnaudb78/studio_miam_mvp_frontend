...
const CardAppart: React.FC<AppartsProps> = ({ _id, title, price, localisation, isProfil, images }) => {
    ...
    return (
        <div className="w-full h-full relative font-satoshi text-secondary-200 mr-1 flex-zero-zero-auto lg:w-[90%]">
