        ...
        <>
            ...
            <section className="h-full w-full flex flex-col gap-10 bg-secondary-200 font-satoshi mb-10">
                <div className="w-full h-full relative text-[12px] flex flex-col justify-center items-center">
                    ...
                    <div className="w-[95%] absolute bg-secondary-200 rounded-full top-8 flex justify-between items-center p-2">
                        <div className="flex justify-start w-full gap-2">
                            <svg className="w-6 h-6 bg-primary p-2 rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#FFFFFF" d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                            <input type="text" placeholder="Rechercher un appart" className="w-full text-start bg-transparent text-primary font-satoshi" />
                        </div>
                ...
                <div className="flex flex-col gap-2 text-center">
                    ...
                    <p className="font-extralight text-[14px]">Faites une pause des réunions Zoom<br></br>
                ...
                <div className="flex justify-center">
                    <button onClick={handleClick} className="bg-secondary-300 py-2 px-4 rounded-full cursor-pointer text-[14px] text-secondary-200">En savoir plus</button>
                </div>
            </section>
            <Footer />
        </>
